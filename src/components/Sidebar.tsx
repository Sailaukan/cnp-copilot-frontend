...
export default function Sidebar({
    ...
    return (
        <div className="w-80 bg-white border-r border-gray-200 flex flex-col h-full">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="relative" ref={createMenuRef}>
                        <button
                            ...
                            className="p-1.5 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-lg transition-all duration-150 hover:scale-105"
                        ...
                        {showCreateMenu && (
                            <div className="absolute right-0 top-full mt-1 bg-white border border-gray-200 rounded-lg shadow-lg z-10 min-w-[120px] animate-in fade-in-0 zoom-in-95 duration-150">
                                <button
                                    onClick={() => {
                                        handleCreate('file');
                                        setShowCreateMenu(false);
                                    }}
                                    className="w-full px-3 py-2 text-left text-sm text-gray-700 hover:bg-gray-50 flex items-center space-x-2 first:rounded-t-lg transition-colors duration-150"
                                >
                                    <FileText size={14} />
                                    <span>File</span>
                                </button>
                                <button
                                    ...
                                    className="w-full px-3 py-2 text-left text-sm text-gray-700 hover:bg-gray-50 flex items-center space-x-2 last:rounded-b-lg border-t border-gray-100 transition-colors duration-150"
                                >
                                    <Folder size={14} />
                                    <span>Folder</span>
                                </button>
            ...
            {/* Footer */}
            <div className="p-3 border-t border-gray-200 h-10">
                <div className="text-xs text-gray-500">
                    <div className="flex justify-between">
                        <span>Files: {countAllFiles(files)}</span>
                        <span>CNP Copilot</span>
                    </div>
                </div>
            </div>
        </div>
